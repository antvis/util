import { formatPath, fillPath, fillPathByDiff } from '../../../src';

describe('PathUtil', () => {
  it('fill L with C', () => {
    const path1 = [
      ['M', 245.7373046875, 242.89436666666668],
      ['L', 611.5791015625, 35.262968333333305],
    ];
    const path2 = [
  ...
  it('format A to L', () => {
    ...
    const path = formatPath(path1, path2);
