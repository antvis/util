...
describe('line intersect', () => {
  ...
  it('intersect', () => {
    // 端点相交
    expect(getLineIntersect({ x: 0, y: 0 }, { x: 100, y: 0 }, { x: 100, y: 0 }, { x: 150, y: 10 })).toEqual({
      x: 100,
      y: 0,
    });
    expect(getLineIntersect({ x: 0, y: 0 }, { x: 100, y: 0 }, { x: 50, y: -50 }, { x: 50, y: 0 })).toEqual({
      x: 50,
      y: 0,
    });
    expect(getLineIntersect({ x: 0, y: 0 }, { x: 100, y: 0 }, { x: 50, y: -50 }, { x: 50, y: 50 })).toEqual({
      x: 50,
      y: 0,
    });
  });
